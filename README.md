...
No seu painel do PostgreSQL crie um banco de dados em branco chamado `usersdb`.
...
* **Rota:** `POST /alugar`
* **Ação:** Insira um Token de Administrador ou Cliente na aba *Authorization* para cadastrar (`POST /alugar`).
